...
sudo cp /etc/letsencrypt/live/nodescape.io/fullchain.pem ~/nodescape/cert/fullchain.pem
sudo cp /etc/letsencrypt/live/nodescape.io/privkey.pem ~/nodescape/cert/privkey.pem
